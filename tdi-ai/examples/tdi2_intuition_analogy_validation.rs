//! Frozen non-final Validation of analogical transfer.
...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    let manifest = frozen_analogy_manifest(CampaignDomain::Validation);
    ...
    println!(
        "tdi2.1-analogy-validation-v1;cases=32;transfer_exact={transfer_exact};no_transfer_exact={no_transfer_exact}"
    );
    Ok(())
}
