...
def _require_candidate_bound_to_partner_step(admitted_partner_step, candidate):
    """Require the NNIS candidate to be the exact root artifact consumed by the admitted step."""
    ...
    if step is None:
        raise NnisPartnerContractError("partner_step is not present in the admitted Graph/v1")
