...
sha256sum Cargo.lock Cargo.toml tdi-ai/Cargo.toml \
  ...
  tdi-ai/src/tdi21_relational_attention.rs \
  tdi-ai/tests/tdi21_relational_attention.rs \
  tdi-ai/src/tdi21_relational_resource_envelope.rs \
  tdi-ai/tests/tdi21_relational_resource_envelope.rs \
  tdi-ai/src/tdi21_relational_matched_component.rs \
  tdi-ai/tests/tdi21_relational_matched_component.rs
...
cargo test --locked -p tdi-ai --features experimental --test tdi21_relational_attention
cargo test --locked -p tdi-ai --features experimental --test tdi21_relational_resource_envelope
cargo test --locked -p tdi-ai --features experimental --test tdi21_relational_matched_component
...
cargo test --locked --release -p tdi-ai --features experimental --test tdi21_relational_attention
cargo test --locked --release -p tdi-ai --features experimental --test tdi21_relational_resource_envelope
cargo test --locked --release -p tdi-ai --features experimental --test tdi21_relational_matched_component
