...
Post-#217 scout found no model/adapter/tokenizer identifier that can be pinned;
...
Rejection/provenance/accounting/registry scaffolding remains non-authorizing;
pins stay **0/12**.
