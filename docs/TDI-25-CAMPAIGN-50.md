...
| 07 | Chiral invariant bridge tests | **cross-stack predecessor** #557; fail-closed M²/J²/MJM and s/m/chi reflection identities through the TDI-25 adapter |
| 08 | Shared masking/normalization reference | **prepared dependency candidate**; reuses TDI-24 mask/normalizer unchanged and rejects unmatched row lengths before normalization |
