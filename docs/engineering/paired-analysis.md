...
`be7fcca3b31cedf722d71a2a56db8f6d088037cf`, the qualified merge of Memorithm/scirust#1452.
Use this immutable merge pin for integration qualification; the binary SHA-256 remains recorded separately.
