...
**Current exact-head qualification note (2026-09-18):** the current default-branch checkpoint for this refresh is `fdde25e74e1bad9696ee5ee3a9fb013b42a20b06`, the qualified merge of Lot-H partner-boundary requalification PR #470 from exact head `44cfeef3e1cd28df0bd88e98620a245c9222acb5`. The immediately preceding non-scientific CI-repair PR #473 qualified on exact head `4e5c271ae39706a2e90f656f5c289544710c0fa6` and merged as `f1e093314d3ca9167fc23e34f1838e73956b47a0`; it provisions the declared Rust 1.85.0 formatter/linter components for readiness gates and does not alter scientific status. Research consultation/reporting PR #409 remains qualified history at merge `30c7c6f00a400ab79cff504233fe923d3a9ced64`. Older qualification-audit files remain historical reconciliation overlays; when an older row conflicts with this newer exact-head evidence, retain the older row only as programme history. Merge presence alone is not a qualification result.
...
1. Continue from default branch `fdde25e74e1bad9696ee5ee3a9fb013b42a20b06`. CI-repair PR #473 qualified on exact head `4e5c271ae39706a2e90f656f5c289544710c0fa6` and merged as `f1e093314d3ca9167fc23e34f1838e73956b47a0`; Lot-H requalification PR #470 then qualified on exact head `44cfeef3e1cd28df0bd88e98620a245c9222acb5` and merged as the current default-branch commit. #470 requalifies the ElasticXxx, SciRust, FLAT-ATTENTION and NNIS contract boundaries only; it creates no execution, actuation, holdout, hardware, scientific-stage, verdict or performance authority.
2. #411 FLAT/NNIS attention adapters remains a mergeable draft candidate at exact head `4ddcbc382c1e089b43b47a263b1d7838ed56ecf0`. It still targets the real FLAT scalar reference and optional NNIS NVRTC path through immutable pins, with physical CUDA execution/parity, GPU timing, VRAM, model-quality and production-routing claims explicitly unqualified. It must be merged forward again from the current default branch and requalified on the resulting exact head before any promotion.
3. #384 TDI-23.2 bounded local rewrite calculus has been merged forward non-destructively from current `main` and is now a mergeable draft candidate at exact head `3440845c7ba153c75fdda3653dbf7f49c7c2eaf9`. Local current-toolchain qualification passes, and the dedicated `TDI-23.2 bounded local rewrite calculus` workflow has succeeded on that exact head; other applicable exact-head workflows remain queued/in progress, so the PR is not merge-qualified. The documented TDI-23.1 freeze prerequisite must still be satisfied before promotion. Rewrite search, recursive optimization, FLAT integration and confirmatory/final execution remain unauthorized.
4. #408 TDI-25.0 torsor-vs-chiral Stage-0 has likewise been merged forward from current `main` and is now a mergeable draft candidate at exact head `f3e8b17b65150ea435e664e1e00f9188b55a96b7`. Its dedicated `TDI-25 Stage-0 torsor vs chiral bootstrap` gate succeeds on the exact head, while other applicable repository workflows remain queued/in progress. No T6/C6 winner, protected/final result, hardware/performance result or model-quality result is authorized by this candidate.
