...
1. Continue from default branch `7eb4a226614fef71710f632026b84e25d17bf6f5`. #464 runner-load scoping qualified on final head `ef34c2ffb5c946e5d5c10f56879d04989618b383` with its applicable exact-head checks successful and material review resolved, then squash-merged as `7eb4a226614fef71710f632026b84e25d17bf6f5`. The protected baseline workflows and the qualified TDI-8.1/TDI-9.1 freeze workflows were not weakened by that change.
2. #388 measured engine benchmarks has been merged forward non-destructively from that default branch to candidate head `47cc7c5cb06e945935b7804c1b2d1e31baef4955`. Local format/diff checks and its six focused benchmark tests pass, while GitHub exact-head qualification is still in progress; queued or pending checks are not qualification evidence and the PR remains draft.
3. #409 research consultation/reporting has been retargeted to `main` and merged forward to candidate head `3974f51a139a48168d71ab9718dcd9c19df5eb86`, preserving both the already-merged sensitivity CLI and its read-only reporting surfaces. Its prior material reporting review is resolved, but refreshed exact-head GitHub qualification is still in progress and the PR remains draft.
4. Treat the old #296 SciRust candidate pin as closed only through qualified corrective PR #466. SciRust #1452 qualified and merged as `be7fcca3b31cedf722d71a2a56db8f6d088037cf`; the unrelated Dream/Thor negative hardware/runtime evidence remains isolated in draft SciRust #1455 and must not be reinterpreted as statistics qualification.
5. Continue measured engine benchmarks and hardware-specific FLAT/NNIS qualification only when the required physical evidence is available. Do not convert queued/pending workflows, local passes, merge presence, or unavailable hardware into qualification claims.
