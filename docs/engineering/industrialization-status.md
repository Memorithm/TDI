...
5. Continue hardware-specific FLAT/NNIS qualification only when the required physical evidence is available. Do not convert local passes, queued/pending workflows, merge presence, or unavailable hardware into qualification claims.
