...
**Current exact-head qualification note (2026-09-17):** later Lot-H/operational/export work advanced after several rows below were written. The current default-branch checkpoint for this refresh is `84ab1e81693fa7ddbe9ead67c44c740495d1b430` (merged PR #465, after #385). For current qualification state of PRs #279, #283–#288, merged-but-provenance-limited #296/#331, qualified #385/#465, and active candidates #387/#388/#389, use [`industrialization-qualification-audit-2026-09-16-r2.md`](industrialization-qualification-audit-2026-09-16-r2.md), which is a reconciliation overlay on the historical [`industrialization-qualification-audit-2026-09-16.md`](industrialization-qualification-audit-2026-09-16.md). Where an older row below conflicts with that evidence, use the newer exact-head evidence and retain the older row only as historical programme context. Merge presence alone is not a qualification result.
...
1. Continue Lot H from exact GitHub state: Forge #39 is merged and #385 is repinned to its final merge revision. After #463 merged the core exact-head/Clippy repair as `13c46500b6d079a515772286bfad3358fc116e6d`, #385 was refreshed onto that main and is now candidate head `b20cbaf053fa446dba9391e521edfdc167b881e5`; it remains blocked on its own complete exact-head gate set rather than on the upstream Forge candidate. #389 remains stacked on #385 and must be resynchronized/qualified after #385 before promotion. #388 measured engine benchmarks and #387 sensitivity remain draft candidates and require synchronization plus complete exact-head gates.
