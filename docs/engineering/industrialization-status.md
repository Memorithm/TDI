...
**Current exact-head qualification note (2026-09-18):** the current default-branch checkpoint for this refresh is `cff0ce6f367d0f41f9df2ddd188630a482e27fdb`, the qualified squash merge of FLAT/NNIS software-boundary PR #411 from exact head `0ef7a81320d5515c54e1dc32101b55051db89097`. Before that merge the candidate was non-draft, mergeable without conflict, all 61 returned exact-head check runs were completed successfully, and no unresolved review thread was present. The slice qualifies bounded public software integration only: the FLAT scalar-reference path and optional NNIS software/CUDA build boundary are exercised, while physical CUDA parity, GPU timing, VRAM, model-quality, production-routing, protected/final and speedup claims remain explicitly unqualified. TDI-25.0 Stage-0 #408, Lot-H partner-boundary requalification #470, CI-repair #473 and consultation/reporting #409 remain qualified history; older qualification-audit files remain historical reconciliation overlays. Merge presence alone is not a qualification result.
...
1. Continue from default branch `cff0ce6f367d0f41f9df2ddd188630a482e27fdb`, qualified FLAT/NNIS software-boundary merge #411 from exact head `0ef7a81320d5515c54e1dc32101b55051db89097`. This merge records bounded software integration only and creates no physical CUDA parity, GPU performance, model-quality, protected/final or production-routing authority.
...
3. #384 TDI-23.2 bounded local rewrite calculus has been merged forward from the new #411 default branch and locally requalified on candidate head `7972520216cbd295ce91d18137fbac66808c8725` (fmt, Clippy, 9 targeted rewrite tests, TDI-9.1 readiness integrity and diff whitespace pass). Its new exact-head GitHub matrix is running and is not transferable from prior heads. Independently, `docs/TDI-23-PROGRAMME.md` and `docs/TDI-23.1-STATUS.md` still declare TDI-23.1 not frozen, so #384 must remain draft even if CI becomes green. Rewrite search, recursive optimization, FLAT integration and confirmatory/final execution remain unauthorized.
