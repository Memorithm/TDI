...
**Current exact-head qualification note (2026-09-18):** the current default-branch checkpoint for this refresh is `3e8636d13a91db624723d32783f58a833bab7af9`, the qualified squash merge of TDI-25.0 Stage-0 PR #408 from exact head `05fb398f9f151922b2418b0c3d7a02a146164e72`. Before that merge the candidate was non-draft, mergeable without conflict, all 67 returned exact-head checks completed successfully, and the ready-for-review automatic review completed on that same head without material review threads. The slice remains a bounded software/scientific-development bootstrap only: it authorizes no T6/C6 winner, protected/final result, hardware/performance result or model-quality result. Earlier Lot-H partner-boundary requalification #470, CI-repair #473 and consultation/reporting #409 remain qualified history; older qualification-audit files remain historical reconciliation overlays. Merge presence alone is not a qualification result.
...
1. Continue from default branch `3e8636d13a91db624723d32783f58a833bab7af9`, qualified TDI-25.0 Stage-0 merge #408 from exact head `05fb398f9f151922b2418b0c3d7a02a146164e72`. The merge records only the bounded T6-vs-C6/G6 development scaffold described above; it creates no protected/final, hardware, performance, quality or winner authority.
2. #411 FLAT/NNIS attention adapters was merged forward non-destructively from this new default branch and is now a mergeable draft candidate at exact head `5fe96976559dc71fd0ba38c54574622850bf3658`. It still targets the real FLAT scalar reference and optional NNIS NVRTC path through immutable pins, with physical CUDA execution/parity, GPU timing, VRAM, model-quality and production-routing claims explicitly unqualified. Its previous-head successes are not transferable; the refreshed exact-head matrix is running and must complete before any promotion.
3. #384 TDI-23.2 bounded local rewrite calculus remains intentionally draft at head `84322a98c3e1ffc9d88cb9bac10318d74b8c1de4`. Its returned checks had all succeeded before #408 changed `main`, but it must be merged forward and requalified before any future promotion. Independently, the documented TDI-23.1 scientific-freeze prerequisite remains unresolved, so it must stay draft even if CI is green. Rewrite search, recursive optimization, FLAT integration and confirmatory/final execution remain unauthorized.
