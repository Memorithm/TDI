...
1. Continue from default branch `807bc13d1d6389cb0314cc18be6c9bd7dc31126e`: #385/#389/#466/#467/#387 are merged for their declared software scopes. #387 final head `4fbd8f8a383a2bb5ddb156eb4fb4cdf8851fa9c2` had all returned exact-head pull-request workflows successful and all material P1 review threads resolved before squash merge.
2. Refresh #388 measured engine benchmarks and #464 runner-load scoping from current `main` before further qualification. Their previously published heads predate #387 and must not be treated as final-head evidence after refresh. Preserve the qualified TDI-8.1/TDI-9.1 freeze workflows byte-for-byte in #464.
...
4. Continue measured engine benchmarks and hardware-specific FLAT/NNIS qualification only when the required physical evidence is available. Do not convert queued/pending workflows, local passes, merge presence, or unavailable hardware into qualification claims.
