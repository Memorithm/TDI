...
| **TDI-9.3** | **Boolean Policy Synthesis: represent, calibrate and later search explicit Boolean action policies over frozen leakage-safe trajectory predicates** | **active design / non-final** (9.3.0 C2 truth-table calibration landed; non-pinning) |
